 ...
 * exhibits the _.extend behaviour. Property value of update overrides
 * property value of base if property name collision occurs
 * @param {String|Array|Object} base The default/base value of `include` option
 * @param {String|Array|Object} update The runtime value of `include` option
 * @returns {Object}
 */
function mergeIncludes(base, update) {
  var baseObj = convertToObject(base);
  var updateObj = convertToObject(update);
  for (var property in updateObj) {
    baseObj[property] = updateObj[property];
  }
  console.log(baseObj);
  return baseObj;
}
...
/**
 * Converts input parameter into an object which wraps the value.
